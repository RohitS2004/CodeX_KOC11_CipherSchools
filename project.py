...
score=0
print("""""""                  """"                    
888888 e   e e  eeeee   888888 88888 eeeeeee eeeeee  
8    8 8   8 8      8   8e     8   8 8  8  8 8    
8    8 8   8 8e eeee8   88  ee 8eee8 8e 8  8 8eee
8 ___8 8   8 88 8       88   8 88  8 88 8  8 88   
888888 88ee8 88 88ee8   88eee8 88  8 88 8  8 88eeee 
...
for i in questionlist:
    ...
    if(a==question[i]):
        ...
        print("\nWrong answer!")
print(f"\nName of the paticipant {userName}")
